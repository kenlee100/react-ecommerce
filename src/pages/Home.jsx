...
export default function Home() {
  ...
  return (
    <>
      <div className="main-slider flex h-[375px] lg:h-[720px]">
        <Swiper
          slidesPerView={1}
          spaceBetween={0}
          modules={modules}
                ...
                <div className="container flex h-full flex-col">
                  <div className="relative z-10 flex h-full flex-col items-center justify-center">
                    <div className="mx-auto flex flex-col items-center text-center text-neutral-100 [&:not(:last-child)]:mb-5 lg:[&:not(:last-child)]:mb-10">
                      <h2 className="en-body lg:en-display [&:not(:last-child)]:mb-5 lg:[&:not(:last-child)]:mb-10">
                        SPACE RENTAL
                      </h2>
                    </div>
                    ...
                    <NavLink
                      to={'/products'}
                      className="btn-large group flex items-center bg-neutral-100 text-neutral-400"
                    >
                      <p>立即前往</p>
                      <div className="icon-arrow -ml-8 flex h-8 w-8 justify-center opacity-0 transition-all duration-100 ease-in-out after:text-2xl group-hover:ml-3 group-hover:text-neutral-400 group-hover:opacity-100 lg:after:text-3xl"></div>
                    </NavLink>
                  </div>
                  <div
